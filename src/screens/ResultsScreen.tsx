...
export const ResultsScreen = ({ history, deleteHistory }: ResultsScreenProps) => {
  ...
  const handleDownload = () => {
    const report = `
# HappyCrops AI - Agricultural Intelligence Report
...
---
Generated by HappyCrops AI | happycropsai.com
    `.trim();
    ...
    a.href = url;
    a.download = `HappyCrops_Report_${result.disease_name.replace(/\s+/g, '_')}.md`;
    ...
    >
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex space-x-2">
          ...
          <button onClick={() => { if (window.confirm('Delete this diagnostic report?')) { deleteHistory(result.timestamp); navigate('/dashboard/diagnostics'); } }} className="bg-surface-container border border-white/10 p-3 rounded-2xl hover:bg-white/10 transition-all text-on-surface-variant hover:text-red-500" title="Delete Report">
